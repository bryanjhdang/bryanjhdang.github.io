  ...
  return (
    <div className="flex sm:flex-row flex-col gap-10">
      ...
      <div className="flex-1">
        ...
        <div className="pb-5">
          <p className="text-base">We used <span className="font-semibold text-blue-500">Unity</span> where I programmed some of the enemy behavior to attack and chase down the player, put the levels together, and used <span className="font-semibold text-blue-500">Aseprite</span> to create most of the assets.</p>
        </div>
        <div>
  ...
  return (
    <div className="flex sm:flex-row flex-col gap-10">
      ...
      <div className="flex-1">
        ...
        <div className="pb-5">
          <p className="text-base">My team used <span className="font-semibold text-blue-500">Godot</span> to create the game where I worked on the puzzle item interactions like switches, levers, doors, platforms, and teleporters. I also worked on the UI for the main menu and the level design. </p>
        </div>
        <div>
