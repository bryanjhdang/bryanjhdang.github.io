  ...
  return (
    <div id="about" className="pt-10 sm:pt-20 pb-10 sm:pb-20">
      <SectionWrapper>
        ...
        <p className="text-sm sm:text-base mb-5">My hobbies include playing games (both virtual and tabletop), reading manga, and binge watching bushcrafting videos on YouTube. Shoutouts to Outdoor Boys. My favorite game is The Great Ace Attorney, and my favorite manga is Haikyuu.</p>
