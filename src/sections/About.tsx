      ...
      <SectionWrapper>
        <div className="flex flex-col lg:flex-row">
          <div className="sm:mr-20 text-base space-y-8">
            ...
            <p>Sometimes <a className="underline" href="https://bryandang.substack.com/" target="_blank">I like to blog about stuff</a>, usually game reviews and random media.</p>
