      ...
      <SectionWrapper>
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="sm:mr-20 text-base">
            ...
            <p className="mb-5">Sometimes <a className="text-blue-600 underline" href="https://bryandang.substack.com/" target="_blank">I like to blog about stuff</a>, like game reviews and cool events.</p>
            ...
            <p className="mb-5">You can get in touch with me through <a className="text-blue-600 underline" href="mailto:bda37@sfu.ca">Email</a> or <a className="text-blue-600 underline"href="https://www.linkedin.com/in/bryanjhdang/" target="_blank">LinkedIn</a>!</p>
          </div>
