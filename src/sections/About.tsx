      ...
      <SectionWrapper>
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="sm:mr-20 text-base space-y-8">
            ...
            <p>My hobbies include playing games (both virtual and tabletop), reading manga, and binge watching bushcrafting videos on YouTube. My favorite game is Baldur's Gate 3, and my favorite manga is Haikyuu.</p>
          </div>
